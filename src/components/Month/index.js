...
function renderWeekdays(styles, dateOptions, weekdayDisplayFormat) {
  const now = new Date();
  return (
    <div className={styles.weekDays} tabindex="-1">
      {eachDayOfInterval({
...
class Month extends PureComponent {
  render() {
    ...
    return (
      <div className={styles.month} style={this.props.style} tabindex="-1">
        ...
        <div className={styles.days} tabindex="-1" onMouseLeave={this.props.onMouseLeave}>
